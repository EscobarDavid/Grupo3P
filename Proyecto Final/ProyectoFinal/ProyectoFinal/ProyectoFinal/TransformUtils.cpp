...
vector<unsigned char> TransformUtils::transformar_string_to_bytes(const string& data)
{
...
string TransformUtils::transformar_byte_a_string(const unsigned char& byte)
{
